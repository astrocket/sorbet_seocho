...
class Booker
  include ::Booker::GeneratedAttributeMethods
  include ::Booker::GeneratedAssociationMethods
end

module Booker::GeneratedAssociationMethods
end
...
module Booker::GeneratedAttributeMethods
end
...
class Reservation
  include ::Reservation::GeneratedAttributeMethods
  include ::Reservation::GeneratedAssociationMethods
  def autosave_associated_records_for_booker(*args); end
end
...
module Reservation::GeneratedAssociationMethods
  ...
  def build_booker(*args, &block); end

  def create_booker(*args, &block); end

  def create_booker!(*args, &block); end

  def reload_booker(); end
end
...
module Reservation::GeneratedAttributeMethods
end
